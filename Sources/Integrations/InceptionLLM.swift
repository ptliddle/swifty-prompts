...
open class InceptionLLM: OpenAILLM {
    ...
    public init(baseUrl: String = InceptionLLM.baseHost, apiKey: String, model: InceptionModelID, systemPromptPrefix: String? = nil, temperature: Double? = 0.0, topP: Double = 1.0, thinkingLevel: ThinkingLevel? = .medium, maxOutputTokens: Int? = 10000, tools: [Tool]? = nil, storeResponses: Bool) {
        super.init(baseUrl: baseUrl, apiKey: apiKey, model: Model.Other(id: model), systemPromptPrefix: systemPromptPrefix, temperature: temperature, topP: topP, thinkingLevel: nil, maxOutputTokens: maxOutputTokens, tools: tools, storeResponses: false)
    }

    public init(with requestHandler: any DelegatedRequestHandler, baseUrl: String = InceptionLLM.baseHost, apiKey: String, model: InceptionModelID, systemPromptPrefix: String? = nil, temperature: Double? = 0.0, topP: Double = 1.0, thinkingLevel: OpenAILLM.ThinkingLevel? = .medium, maxOutputTokens: Int? = 10000, tools: [Tool]? = nil, storeResponses: Bool) {
        super.init(with: requestHandler, baseUrl: baseUrl, apiKey: apiKey, model: Model.Other(id: model), systemPromptPrefix: systemPromptPrefix, temperature: temperature, topP: topP, thinkingLevel: nil, maxOutputTokens: maxOutputTokens, tools: tools, storeResponses: false)
    }
